...
function get(arg, keys) {
  ...
  if (keys) {
	...
	var matched_networks = []; // qxhan
    for (var index in networks) {
      if (_.any(keys, containsArg)) {
        //return networks[index]; // qxchan
		matched_networks.push(networks[index]); // qxhan
      }
    }
    //return undefined; // qxchan
	return matched_networks; // qxhan
  }
...
var TESTNET = {
  PORT: 19993,
  NETWORK_MAGIC: BufferUtil.integerAsBuffer(0x83fc34f0),
  DNS_SEEDS: [
	'dnsseed-1.firstep-it.net',
	'dnsseed-2.firstep-it.net'
  ]
...
var REGTEST = {
  PORT: 29993,
  NETWORK_MAGIC: BufferUtil.integerAsBuffer(0x85fe36f2),
  DNS_SEEDS: []
};
